...
async function EditRentalPage({ params }: { params: { id: string } }) {
  // console.log('params : ', params); // params :  { id: '242b4ccd-a2b1-4ff0-9d74-738525ce298e' }
    ...
    <section>
      ...
      <div className="border p-8 rounded-md ">
        <ImageInputContainer
          ...
          image={property.image} // current image
        >
          {/* {props.children} in ImageInputContainer -> this will be needed in updatePropertyImageAction  */}
